# 🏛️ 국회 의사중계 자막 추출기 (Korea Assembly CC)
...
수집한 자막은 TXT, SRT, VTT, DOCX, HWPX, HWP, RTF, JSON 세션으로 저장할 수 있습니다. Python과 Chrome을 설치한 뒤 아래 설치 방법의 명령으로 바로 실행할 수 있으며, 최신 배포본은 [GitHub Releases](https://github.com/twbeatles/korea-assembly-cc/releases)에서 받을 수 있습니다.
...
- 국회 생중계의 회의·발언을 실시간으로 기록하고 나중에 다시 검토
- 관심 키워드를 모니터링하고 관련 자막을 빠르게 검색
- 연구·보도·시민 활동을 위한 자막 초안과 발언 기록 수집
- 영상 자막 표준인 SRT/VTT 또는 문서 형식으로 내보내 후속 편집·공유
- 수집한 세션을 JSON/SQLite 이력으로 보관하고 필요한 구간을 재확인

이 도구는 자막을 수집하고 정리하는 기능에 집중합니다. 특정 정치인·정당·정책에 대한 평가나 분석을 제공하지 않습니다.
...
- 원본은 국회 의사중계 페이지에서 제공하는 **AI 자막**이므로 음성 인식·구두점·고유명사·발언자 구분에 오류가 포함될 수 있습니다.
- 이 프로그램의 결과는 공식 회의록이나 법적·공식 기록과 동일하지 않습니다. 인용·보도·분석 등 정확성이 중요한 용도에는 국회가 공개한 공식 회의록 또는 원본 영상과 대조하세요.
- 국회 의사중계 사이트의 화면 구조, 자막 제공 방식, 방송 상태가 바뀌면 수집 기능에 영향을 줄 수 있습니다.
- 타임스탬프와 발언자 구분은 수집 시점의 웹 자막 정보에 근거하므로, 최종 사용 전에 필요한 부분을 확인·수정해야 합니다.
