...
> **현재 상태**: v16.14.8까지 반영 완료 (2026-07-29 soft_resync 긴 compact 유지 포함). 아래 §2의 분석 범위(글로벌 히스토리 + suffix 코어 의미론)는 전 버전에 걸쳐 변경 없이 유지됨. 상세 수정 이력은 `PIPELINE_LOCK.md` §2.1 참고.  
